CREATE DATABASE  IF NOT EXISTS `curs0155_dbcursos_sbc` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `curs0155_dbcursos_sbc`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 50.116.86.90    Database: curs0155_dbcursos_sbc
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'curs0155_dbcursos_sbc'
--
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_endereco_pessoa_update`(
pidperson INT,
pidpess INT,
prua VARCHAR(128),
pnumero VARCHAR(16),
...
-- Dump completed on 2021-09-11 22:31:18
