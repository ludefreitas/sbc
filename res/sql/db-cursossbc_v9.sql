...
INSERT INTO `tb_insc` VALUES (45,7,123,3,4,1,'2021-02-05 20:11:07'),(46,7,124,7,4,1,'2021-02-05 20:19:31'),(47,7,125,7,4,1,'2021-02-05 20:20:22'),(57,7,136,23,4,2,'2021-02-05 21:51:38'),(58,7,137,23,4,3,'2021-02-05 21:52:40'),(59,7,138,10,4,1,'2021-02-05 21:58:06'),(60,7,140,10,4,2,'2021-02-05 21:59:51'),(61,7,141,10,4,3,'2021-02-05 22:03:03'),(62,7,151,29,4,5,'2021-02-17 19:51:28'),(63,7,158,4,4,7,'2021-02-18 14:06:10'),(64,7,165,28,4,2,'2021-02-18 18:49:01'),(65,7,169,27,4,13,'2021-05-17 23:40:19'),(67,7,198,28,4,4,'2021-06-01 01:16:09'),(68,7,201,4,53,1,'2021-06-11 01:46:28'),(94,7,207,7,4,4,'2021-06-11 21:05:58'),(95,7,209,23,4,3,'2021-06-11 21:15:50'),(96,7,209,23,4,4,'2021-06-11 21:16:13'),(97,7,210,3,4,3,'2021-06-11 21:30:24'),(98,7,210,3,4,4,'2021-06-11 21:31:27'),(99,7,211,28,4,5,'2021-06-11 21:32:36'),(100,7,212,5,4,8,'2021-06-11 21:40:47'),(101,7,213,5,4,9,'2021-06-11 21:47:19'),(102,7,213,5,4,10,'2021-06-11 21:47:33'),(103,7,213,5,4,11,'2021-06-11 21:47:53'),(104,7,213,5,4,12,'2021-06-11 21:48:23'),(105,7,214,29,4,25,'2021-06-14 22:28:01'),(106,7,216,29,4,26,'2021-06-15 01:57:14'),(107,7,220,23,4,5,'2021-06-18 13:52:12');
...
INSERT INTO `tb_modalidade` VALUES (1,'Artesanato'),(2,'Dança'),(3,'Futebol'),(4,'Futsal'),(5,'Ginástica'),(6,'Hidroginástica'),(7,'Voleibol'),(8,'Tênis'),(9,'Badminton'),(10,'Basquetebol'),(11,'Handebol'),(12,'Lutas'),(14,'Natação'),(16,'Artes Marciais'),(17,'Skate');
...
--
-- Table structure for table `tb_sorteio2016`
--

DROP TABLE IF EXISTS `tb_sorteio2016`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_sorteio2016` (
  `idsorteio` int(11) NOT NULL AUTO_INCREMENT,
  `idtemporada` int(11) NOT NULL DEFAULT 58,
  `idstatussort` int(11) NOT NULL DEFAULT 1,
  `numerodeordem` int(11) DEFAULT NULL,
  `numerosortear` int(11) NOT NULL,
  PRIMARY KEY (`idsorteio`),
  KEY `fk_sorteio2016_sorteiostatus_idx` (`idstatussort`),
  KEY `fk_sorteio2016_sorteiotemporada_idx` (`idtemporada`),
  CONSTRAINT `fk_sorteio2016_sorteiostatus` FOREIGN KEY (`idstatussort`) REFERENCES `tb_sorteiostatus` (`idstatussort`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sorteio2016_sorteiotemporada` FOREIGN KEY (`idtemporada`) REFERENCES `tb_temporada` (`idtemporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_sorteio2016`
--

LOCK TABLES `tb_sorteio2016` WRITE;
/*!40000 ALTER TABLE `tb_sorteio2016` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_sorteio2016` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tb_sorteio2019`
--

DROP TABLE IF EXISTS `tb_sorteio2019`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_sorteio2019` (
  `idsorteio` int(11) NOT NULL AUTO_INCREMENT,
  `idtemporada` int(11) NOT NULL DEFAULT 53,
  `idstatussort` int(11) NOT NULL DEFAULT 1,
  `numerodeordem` int(11) DEFAULT NULL,
  `numerosortear` int(11) NOT NULL,
  PRIMARY KEY (`idsorteio`),
  KEY `fk_sorteio2019_sorteiostatus_idx` (`idstatussort`),
  KEY `fk_sorteio2019_sorteiotemporada_idx` (`idtemporada`),
  CONSTRAINT `fk_sorteio2019_sorteiostatus` FOREIGN KEY (`idstatussort`) REFERENCES `tb_sorteiostatus` (`idstatussort`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sorteio2019_sorteiotemporada` FOREIGN KEY (`idtemporada`) REFERENCES `tb_temporada` (`idtemporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_sorteio2019`
--

LOCK TABLES `tb_sorteio2019` WRITE;
/*!40000 ALTER TABLE `tb_sorteio2019` DISABLE KEYS */;
INSERT INTO `tb_sorteio2019` VALUES (1,4,1,4,10),(2,4,1,6,11);
/*!40000 ALTER TABLE `tb_sorteio2019` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tb_sorteio2020`
--

DROP TABLE IF EXISTS `tb_sorteio2020`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_sorteio2020` (
  `idsorteio` int(11) NOT NULL AUTO_INCREMENT,
  `idtemporada` int(11) NOT NULL DEFAULT 57,
  `idstatussort` int(11) NOT NULL DEFAULT 1,
  `numerodeordem` int(11) DEFAULT NULL,
  `numerosortear` int(11) NOT NULL,
  PRIMARY KEY (`idsorteio`),
  KEY `fk_sorteio2020_sorteiostatus_idx` (`idstatussort`),
  KEY `fk_sorteio2020_sorteiotemporada_idx` (`idtemporada`),
  CONSTRAINT `fk_sorteio2020_sorteiostatus` FOREIGN KEY (`idstatussort`) REFERENCES `tb_sorteiostatus` (`idstatussort`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sorteio2020_sorteiotemporada` FOREIGN KEY (`idtemporada`) REFERENCES `tb_temporada` (`idtemporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_sorteio2020`
--

LOCK TABLES `tb_sorteio2020` WRITE;
/*!40000 ALTER TABLE `tb_sorteio2020` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_sorteio2020` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tb_sorteio2021`
--

DROP TABLE IF EXISTS `tb_sorteio2021`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_sorteio2021` (
  `idsorteio` int(11) NOT NULL AUTO_INCREMENT,
  `idtemporada` int(11) NOT NULL DEFAULT 4,
  `idstatussort` int(11) NOT NULL DEFAULT 1,
  `numerodeordem` int(11) DEFAULT NULL,
  `numerosortear` int(11) NOT NULL,
  PRIMARY KEY (`idsorteio`),
  KEY `fk_sorteio2021_sorteiostatus_idx` (`idstatussort`),
  KEY `fk_sorteio2021_sorteiotemporada_idx` (`idtemporada`),
  CONSTRAINT `fk_sorteio2021_sorteiostatus` FOREIGN KEY (`idstatussort`) REFERENCES `tb_sorteiostatus` (`idstatussort`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sorteio2021_sorteiotemporada` FOREIGN KEY (`idtemporada`) REFERENCES `tb_temporada` (`idtemporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_sorteio2021`
--

LOCK TABLES `tb_sorteio2021` WRITE;
/*!40000 ALTER TABLE `tb_sorteio2021` DISABLE KEYS */;
INSERT INTO `tb_sorteio2021` VALUES (1,4,1,2,5),(2,4,1,3,6),(3,4,1,4,10);
/*!40000 ALTER TABLE `tb_sorteio2021` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_temporada` VALUES (4,'2021',4,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','2020-12-04 01:06:02'),(53,'2019',8,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','2021-06-06 18:56:30'),(57,'2020',1,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','2021-06-15 00:21:01'),(58,'2016',2,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','2021-06-18 13:55:12');
...
INSERT INTO `tb_turma` VALUES (2,1,6,17,5,12,3,'Hidro 3ª idade',35),(3,2,6,17,6,12,3,'Hidroginástica',35),(4,2,6,17,7,12,3,'Hidroginástica',35),(5,2,6,17,8,12,3,'Hidroginástica',35),(6,1,6,17,13,13,3,'Hidro 3ª idade',35),(7,2,6,17,14,13,3,'Hidroginástica',35),(10,2,6,17,16,13,3,'Hidroginástica',35),(11,2,6,17,15,13,3,'Hidroginástica',35),(12,1,6,17,9,11,3,'Hidro 3ª idade',35),(13,2,6,17,10,21,3,'Hidroginástica',35),(14,2,6,17,11,21,3,'Hidroginástica',35),(15,2,6,17,12,21,3,'Hidroginástica',35),(16,1,6,17,18,19,3,'Hidro 3ª idade',35),(17,2,6,17,19,20,3,'Hidroginástica',35),(18,2,6,17,20,13,3,'Hidroginástica',35),(19,2,6,17,21,19,3,'Hidroginástica',35),(20,1,6,17,22,12,3,'Hidro 3ª idade',35),(21,2,6,17,23,11,3,'Hidroginástica',35),(22,2,6,17,24,13,3,'Hidro Inclusiva',35),(23,3,6,17,25,11,3,'Hidro Inclusiva',35),(24,1,6,17,26,21,3,'Hidro 3ª idade',35),(25,2,6,17,27,21,3,'Hidroginástica',35),(26,2,6,17,28,13,3,'Hidroginástica',35),(27,2,6,17,29,21,3,'Hidroginástica',35),(28,4,2,30,30,11,3,'Dança Fitness',25),(29,5,2,30,31,11,3,'Ritmos',25);
...
INSERT INTO `tb_turmatemporada` VALUES (4,2,0),(4,3,4),(4,4,7),(4,5,12),(4,6,0),(4,7,4),(4,10,6),(4,16,0),(4,23,5),(4,27,13),(4,28,5),(4,29,26),(53,2,0),(53,4,1),(53,6,0),(58,2,0);
...
-- Dump completed on 2021-06-22 23:21:24
