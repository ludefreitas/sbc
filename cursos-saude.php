...
$app->get("/cursos/saude-atualiza/:idpess/:nomepess", function($idpess, $nomepess) {
...
$app->post("/cursos/buscacid/:idpess/:nomepess", function($idpess, $nomepess){
...
$app->post("/cursos/registersaude", function(){
	...
	if(!isset($_POST['auditiva']) && !isset($_POST['visual']) && !isset($_POST['fisica']) && !isset($_POST['intelectual']) && !isset($_POST['autismo']) && !isset($_POST['tea'])){
		...
		header("Location: /cursos/saude-atualiza/".$_POST['idpess']."/".$_POST['nomepess']."");
		exit;
	}
...
$app->get("/cursos/user/saude/pessoa/:idpess", function($idpess) {
