      ...
      <table>
          ...
          <tr style="padding: 5px">
              ...
              <td style="text-align: center; border: solid 1px; padding: 5px;">
                ...
                <?php }else{ ?>
                <a href="/estagiario/agendamarcarpresenca/<?php echo htmlspecialchars( $value1["idagen"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $idlocal, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $data, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success">
