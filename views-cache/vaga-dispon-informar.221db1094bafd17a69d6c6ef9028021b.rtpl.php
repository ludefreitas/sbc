                        ...
                        <table class="body-text">
                          ...
                          <tr>
                            <td class="body-text-cell">
                              <!--
                              Verificamos que você inscreveu o(a) <?php echo htmlspecialchars( $nomepess, ENT_COMPAT, 'UTF-8', FALSE ); ?> para a turma de <?php echo htmlspecialchars( $turma["descativ"], ENT_COMPAT, 'UTF-8', FALSE ); ?> no <?php echo htmlspecialchars( $turma["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.
                              Informamos que a matrícula será realizada no dia 03/03/2022 (quinta-feira) às 19 horas no próprio CREC com a professora Grazi.
                              Devido a grande procura e buscando um melhor atendimento, será oferecido 02 horários, sendo a primeira turma das 19 às 20 horas, e a segunda turma das 20 ás 21 horas. As aulas serão realizadas na sala de Ginástica, por esse motivo, vamos iniciar com 25 vagas para cada horário. A escolha do horário será feita de acordo com a classificação do sorteio.
                              Assim, caso você tenha interesse em participar da turma, pedimos que compareça no <?php echo htmlspecialchars( $turma["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, rua <?php echo htmlspecialchars( $turma["rua"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $turma["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, às 19 horas do dia 03/03/2022 (quinta-feira) para confirmar sua matrícula.
                              Você deve levar seus documentos pessoais (RG, CPF), comprovante de residência, comprovante de vacinação contra COVID-19, e laudo médico (se for o caso).
