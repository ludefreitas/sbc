  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Minhas Turmas</span>
        ...
        <!--
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Minhas Inscrições</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <?php if( UserIsProf() ){ ?>
            ...
            <li class="treeview">
                          ...
                          <a href="/estagiario/calendarioagendabaetao/3">
                            <i class="fa fa-link"></i> 
                            Agenda Baetão
                          </a>                      
            ...
            <li class="treeview">
                          ...
                          <a href="/estagiario/calendarioagendapauliceia/21">
                            <i class="fa fa-link"></i> 
                            Agenda Paulicéia
                          </a>                      
           ...
           <?php if( UserIsProf() ){ ?>
            ...
            <?php }else{ ?>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="/estagiario/pessoas"><i class="fa fa-users"></i>Alunos</a></li>          
              </ul>
