...
<div class="row">
  ...
  <div class="col-md-12">
      ...
      <div class="box-body" style="border: solid 1px lightblue; margin: 5px; padding-bottom: 0; "> 
        <form action="/admin/turma-temporada-hoje/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/local/<?php echo htmlspecialchars( $local["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="GET">
