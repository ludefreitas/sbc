      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/audi/users"><i class="fa fa-users"></i>Todos Usuários</a></li>

            <li><a href="/audi/pessoas"><i class="fa fa-users"></i>Alunos</a></li>          
          </ul>
        </li> 
        <li class="treeview">
          <a href="/audi"><i class="fa fa-link"></i> <span>TURMAS por temporada</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <!-- { //include="turma-temporada-menu"} -->
          </ul>
        </li>

        <li class="treeview">
          <a href="/audi"><i class="fa fa-link"></i> <span>Controle de Frequência</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <!-- { //include="controle-frequencia-menu"} -->
          </ul>
          <!--
          <ul class="treeview-menu">
            <li>
              <a href="/audi/controle-frequencia/4"><i class="fa fa-link"></i> <span> Contr. Freq. 2021</span>
              <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
        ...
        <li class="treeview">
          <a href="/audi"><i class="fa fa-link"></i> <span>Inscrições</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <!-- {// include="insc-temporada-menu"} --> 
          </ul>
        </li>   
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="treeview">
                      <a href="/audi/calendarioagendabaetao/3">
                        <i class="fa fa-link"></i> 
                        Agenda Baetão - 2022
                      </a>                      
                  </li>
            <li class="treeview">
                      <a href="/audi/calendarioagendapauliceia/21">
                        <i class="fa fa-link"></i> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="treeview">
                      <a href="/audi/calendarioagenda-avaliacao/3">
                        <i class="fa fa-link"></i> 
                        Agenda Baetão
                      </a>                      
                  </li> 
            <li class="treeview">
                      <a href="/audi/calendarioagenda-avaliacao/21">
                        <i class="fa fa-link"></i> 
                        Agenda Pauliceia
                      </a>                      
                  </li>                       
        ...
        <li>
          <a href="/audi/local"><i class="fa fa-link"></i> <span>Crecs</span></a>
        </li>
