      ...
      */
        ...
        let calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          dateClick: function(info) {
            ...
            window.location.href=`http://www.cursosesportivos.com.br/prof/insc-turma-temporada-fazer-chamada/` + idtemporada + '/' + idturma + '/' + info.dateStr;          
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
          Selecione a data e o dia da semana para atualizar a lista de presença da turma: <br> [<?php echo htmlspecialchars( $idturma, ENT_COMPAT, 'UTF-8', FALSE ); ?>] - <?php echo htmlspecialchars( $descturma, ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $dia1, ENT_COMPAT, 'UTF-8', FALSE ); ?> e <?php echo htmlspecialchars( $dia2, ENT_COMPAT, 'UTF-8', FALSE ); ?>
      </h1>
