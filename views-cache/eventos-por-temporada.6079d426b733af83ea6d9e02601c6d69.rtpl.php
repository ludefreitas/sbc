                ...
                <div class="box-body" style="border: solid 1px lightblue; margin: 5px;"> 
                    <div class="box-body col-md-2">
                        <?php $counter1=-1;  if( isset($locais) && ( is_array($locais) || $locais instanceof Traversable ) && sizeof($locais) ) foreach( $locais as $key1 => $value1 ){ $counter1++; ?>
                            <a href="/admin/eventos-por-temporada/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/local/<?php echo htmlspecialchars( $value1["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                <i class=""></i>
                        ...
                        <?php $counter1=-1;  if( isset($modalidades) && ( is_array($modalidades) || $modalidades instanceof Traversable ) && sizeof($modalidades) ) foreach( $modalidades as $key1 => $value1 ){ $counter1++; ?>
                            <a href="/admin/turma-temporada/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/modalidade/<?php echo htmlspecialchars( $value1["idmodal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                <i class=""></i>
                                <?php echo htmlspecialchars( $value1["descmodal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                            </a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php } ?>
                        <a style="font-weight: bold" href="/admin/eventos-por-temporada/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            <i class=""></i>
                            TODOS OS LOCAIS
                        </a>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="col-md-6" >
                            <span style="text-align: left;">
                                ...
                                <?php if( $value1["idstatus_evento"] == 1 ){ ?>
                                    <span>
                                        <a id="idlinkstatus<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color: orange; font-weight: bold; text-align-last: right;" onclick="atualizaStatus(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">
                                            - Iniciado
                                        </a>
                                    </span>
                                <?php } ?>
                                ...
                                <?php if( $value1["tem_divulgacao"] == 1 ){ ?>
                                    <span>
                                        <a id="idlinkstatus<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color: darkred; font-weight: bold; text-align-last: right;" onclick="atualizaDivulgacao(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">
                                ...
                                <?php if( $value1["termina_mesmo_dia"] == 1 ){ ?>

                                    <?php if( $value1["tem_hora_termino"] == 1 ){ ?>

                                        Data do evento: <?php echo formatDate($value1["dia_inicio_evento"]); ?> das <?php echo htmlspecialchars( $value1["hora_inicio_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?> às <?php echo htmlspecialchars( $value1["hora_termino_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>                    

                                    <?php }else{ ?>

                                        Data do evento: <?php echo formatDate($value1["dia_inicio_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_termino_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                ...
                                <?php }else{ ?>
                                    ...
                                    <?php if( $value1["tem_hora_termino"] == 1 ){ ?>
                                        ...
                                        - Evento inicia em: <?php echo formatDate($value1["dia_inicio_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_termino_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?> e termina no dia <?php echo formatDate($value1["dia_final_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_termino_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>                                    
                                           

                                    <?php }else{ ?>

                                        - Evento inicia em: <?php echo formatDate($value1["dia_inicio_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_termino_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?> e termina no dia <?php echo formatDate($value1["dia_final_evento"]); ?> 
                                ...
                                - <?php echo htmlspecialchars( $value1["nomeespaco"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - 

                                <strong>
                                    Professor: <?php if( $value1["idperson"] == 1 ){ ?> Admin Master <?php }else{ ?> <?php echo htmlspecialchars( $value1["apelidoperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <?php } ?>
                                </strong>
                                ...
                                <strong>
                                    Informações: <?php echo htmlspecialchars( $value1["telef_inform_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                </strong>

                                <?php if( $value1["tem_transporte"] == 1 ){ ?>

                                    <?php if( $value1["termina_mesmo_dia"] == 1 ){ ?>

                                        - Saída do transporte: <?php echo formatDate($value1["dt_saida_transporte_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_saida_transporte_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - Retorno do transporte 
                                    <?php }else{ ?>

                                        - Saída do transporte: <?php echo formatDate($value1["dt_saida_transporte_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_saida_transporte_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - Retorno do transporte <?php echo formatDate($value1["dt_retorno_transporte_evento"]); ?> às <?php echo htmlspecialchars( $value1["hora_retorno_transporte_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                ...
                                <div id="escondido1<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" hidden>
                                    ...
                                    <strong>
                                        Programa: <?php echo htmlspecialchars( $value1["programa_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>&nbsp; 
                                    </strong>       

                                    - Origem: <?php echo htmlspecialchars( $value1["origem_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>&nbsp; 

                                    <strong>
                                      <?php if( $value1["so_para_alunos"] == 1 ){ ?>
                                      ...
                                      <?php } ?>
                                        ...
                                        <strong>
                                            <?php if( $value1["tem_categoria_unica"] == 1 ){ ?> - &nbsp;
                                        ...
                                        <strong>
                                            &nbsp;Tipo de resultado: <?php echo htmlspecialchars( $value1["tipo_resultado_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                        </strong>

                                        <?php if( $value1["tem_regras"] == 1 ){ ?>
                                            - &nbsp;<a href="/../res/admin/eventos/regras/<?php echo htmlspecialchars( $value1["pdf_regras_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Regras </a> &nbsp; 
                                            - &nbsp;<span onclick="regras(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">Atualizar regras </span> &nbsp; 
                                        <?php }else{ ?>
                                            - &nbsp;<span onclick="regras(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">Regras</span>&nbsp; 
                                        <?php } ?>

                                        <?php if( $value1["tem_imagem"] == 1 ){ ?>
                                            - &nbsp;<a href="/../res/admin/eventos/img/<?php echo htmlspecialchars( $value1["imagem_arquivo_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Imagem </a> &nbsp; 
                                            - &nbsp;<span onclick="imagem(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">Atualizar imagem </span> &nbsp;
                                        <?php }else{ ?>
                                            - &nbsp;<span onclick="imagem(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">Imagem</span>&nbsp; 
                                        <?php } ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <h5 style="font-weight: bold; text-align: left; color: green;">
                                    <strong style="color: orange;">
                                        [<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>]
                                    </strong> &nbsp;&nbsp;
                                    ...
                                    <a href="/admin/calendario-evento-lista-presenca/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color: orangered;">
                                        | &nbsp; Fazer Chamada &nbsp; |
                                    </a> &nbsp;  
                                    ...
                                    <span id="lermais<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color: darkblue;" onclick="expandir(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">
                                        Ler mais...
                                    </span> 
                                    ...
                                    <span id="escondido2<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" hidden>
                                        <span style="color: black;" id="escondido3<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" hidden>
                                            ...
                                            <span style="font-weight: normal;"> 
                                                <?php echo htmlspecialchars( $value1["obs_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?> 
                                            </span>
                                        </span>
                                    <br>
                                    </span>
                                              
                                <span id="lermenos<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color: darkblue; font-weight: bold;" hidden onclick="recolher(<?php echo htmlspecialchars( $value1["id_evento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)">
                                    Ler menos...
                                </span>                         
                            </h5>
                        </div>                  
                ...
                <div class="box-footer clearfix">
                    <ul class="pagination pagination-sm no-margin pull-right">
                        <?php $counter1=-1;  if( isset($pages) && ( is_array($pages) || $pages instanceof Traversable ) && sizeof($pages) ) foreach( $pages as $key1 => $value1 ){ $counter1++; ?>
                            <li>
                                <a href="<?php echo htmlspecialchars( $value1["href"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                    <?php echo htmlspecialchars( $value1["text"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
