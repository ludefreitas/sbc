      ...
      */
      ...
      function atualizarAtestado(url){
        ...
        $.ajax({
          ...
          let linkatestado = idpess;

          alert(linkatestado)
          document.getElementById(linkatestado).style.color = 'blue';
          ...
          background: lightgray;
            ...
            <div class="container">
              ...
              <div style="text-align-last: right; margin-right: 25px; margin-top: -25px; margin-bottom: 15px;">
                <a href="/estagiario/calendario-lista-presenca/<?php echo htmlspecialchars( $idtemporada, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $turma["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
             ...
             <div class="row" style="margin-right: 0px; font-size: 14px">
              ...
              <div class="row" style="margin-right: 0px; font-size: 14px">
                    ...
                    <div class="col-md-12" style="border: 1px solid black;">                        
                      <div class="row">  
                        <div class="col-md-12" style="margin: 5 0 5 0; text-align: left; font-weight: bold;">
                         ...
                         -->
                         <a id="linkatestado<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color: orange; text-align-last: right;" onclick="dadosAtestado(<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)"><?php echo getAtestadoIconeByNumCpf($value1["numcpf"]); ?></a>                     
                          <br><br>
                ...
                <div class="col-md-12 btn btn-success" style="font-weight: bold; font-size: 16x; text-align: center; margin-top: 10px;">
                  <a style="color: white;" href="/estagiario/insc-turma-temporada-fazer-chamada/<?php echo htmlspecialchars( $idtemporada, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $turma["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $data, ENT_COMPAT, 'UTF-8', FALSE ); ?>">Atualizar Lista</a>
                </div>
