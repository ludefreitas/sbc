<?php if(!class_exists('Rain\Tpl')){exit;}?>
    ...
    #divPopupAtestadoDerma{
        ...
        background-color: rgba(255, 165, 0, 1);
            ...
            <div  id="divPopupAtestadoDerma" style="text-align-last: center; border-radius: 15px 15px 15px 15px"> 
                
                
                <div style="text-align: center; padding: 5; width: 100%;">
                    <form id="formAtestadoDerma" method="post" style="height: 100%; margin-top: 20px" action="/prof/saude/atulizaatestadoderma"> 
                        <label style="font-weight: bold; font-size: 10px">Preencha os dados abaixo para atualizar o atestado dermatológico</label>
                        <input hidden  id="conteudoAtestadoDermaId" name="idpess" type="text" value="<?php echo htmlspecialchars( $idpess, ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                        <input id="dataderma" name="dataderma" type="text" required="required" style="height: 30px; margin-bottom: 2px; width: 90%" placeholder="Só números 00-00-0000">
                        <br> 
                        ...
                        <br> 
                         ...
                         <button class="btn btn-success"  name="enviar" style="margin-top: 2px; width: 44%; font-size: 60%" onclick="submit('formAtestadoDerma')"> Atualizar </button>
                        <!--
