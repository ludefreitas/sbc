...
<div id="div1">
  ...
  <div class="div-center rounded">
    ...
    <h5 id="title" hidden><?php echo htmlspecialchars( $descturma, ENT_COMPAT, 'UTF-8', FALSE ); ?>_<?php echo htmlspecialchars( $idturma, ENT_COMPAT, 'UTF-8', FALSE ); ?></h5>  
      ...
      <table class="table table-bordered" id="table">
        ...
        <tbody>
          <tr style="padding: 5px"> 
              ...
              <td style="text-align: center; border: solid 1px; padding: 5px;">
                <?php if( getUserId() == 1 OR getUserId() == 7 OR getUserId() == 156 OR getUserId() == 27659 OR getUserId() == 22284 OR getUserId() == 22023 ){ ?>
