                        ...
                        <table class="body-text">
                          ...
                          <tr>
                            <td class="body-text-cell">  
                              ...
                              O(A) <?php echo htmlspecialchars( $nomepess, ENT_COMPAT, 'UTF-8', FALSE ); ?> está inscrito(a) na <?php echo htmlspecialchars( $turma["descativ"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dos nossos cursos esportivos para a temporada 2022. Para saber mais detalhes sobre sua inscrição, faça o login em sua conta, no nosso site, acessando seu perfil, clicando na aba "Minhas inscrições" e verifique o status desta inscrição.
                          ...
                          <tr>                            
                            <td class="body-text-cell">
                              Clique no link abaixo, para acessar o site e conferir mais detalhes da inscrição <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
