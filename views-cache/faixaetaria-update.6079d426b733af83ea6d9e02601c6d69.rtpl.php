...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/admin/faixaetaria">Faixas Etária</a></li>
    <li><a href="/admin/faixaetaria/create">Criar Nova Faixa Etária</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/faixaetaria/<?php echo htmlspecialchars( $faixaetaria["idfxetaria"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
