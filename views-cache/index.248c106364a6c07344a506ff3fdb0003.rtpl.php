...
<hr style="background-color: #0f71b3;">
  ...
  <div class="col-md-12" style="border: 5px; font-family: 'Helvetica Neue', Helvetica, Arial,sans-serif;"> 
       ...
       <span>(Atualizado 20/01/2023)
        ...
        <span id="mais">
        <br><br>
        O Programa “Hora do Treino” oferece cursos de iniciação esportiva, direcionados às crianças e adolescentes, com idade entre 7 e 17 anos, e compreende a iniciação esportiva nas modalidades de futsal, vôlei, basquete, handebol, badminton, natação entre outros.
        <br><br>

        Para o público adulto, a partir dos 18 anos de idade, as atividades desenvolvidas através do Programa “Corpo em Ação” compreendem a ginástica, hidroginástica, alongamento, yoga, tai chi chuan, pilates, ginástica funcional, entre outras atividades para adultos e idosos, com o objetivo de promover a saúde da população.
        <br><br>   
        ...
        <a href="http://www.saobernardo.sp.gov.br/documents/1136654/1572881/Edital+2023/17c16f83-8a66-f3e6-853b-8561dc1c8ca4" target="_blank"> Resolução 003/2022</a>,
        

        as vagas serão preenchidas gradualmente, permitindo inicialmente, apenas a escolha de uma modalidade por pessoa, sendo oportunizado gradualmente o acesso a mais cursos ao longo do ano.
        <br><br>           

        A partir de 01 de novembro de 2022, as vagas para os Programas “Corpo e Ação” e “Hora do Treino” já foram disponibilizadas no site. A partir de 01 de fevereiro, serão disponibilizadas novas turmas dos “PELC”, Ginástica Artística e Ginástica Rítmica, Artes Marciais, Zumba e Escolinhas de Esporte.
        <br><br>          

        As inscrições pelo site ficarão disponíveis durante todo o ano, e o munícipe interessado, poderá acompanhar e se inscrever gratuitamente para as vagas disponíveis!  
        <br><br>           
