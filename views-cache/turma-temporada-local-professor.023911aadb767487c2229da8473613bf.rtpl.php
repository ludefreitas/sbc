...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/professor/professor-temporada/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Professores da temporada <?php echo htmlspecialchars( $temporada["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    <!-- <li><a href="/professor/turma-temporada/"></a></li>
    <li class="active"><a href="/professor/temporada/turma"></a></li>-->
  </ol>
</section>
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tbody>                            
                            ...
                            <tr>
                            <td>
                                <a href="/professor/turmatemporada/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class=""></i> <?php echo htmlspecialchars( $value1["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $value1["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                            </td>
                            </tr>
                            <?php } ?>
                        </tbody>
