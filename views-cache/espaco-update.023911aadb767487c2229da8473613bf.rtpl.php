        ...
        <form role="form" action="/professor/espaco/<?php echo htmlspecialchars( $espaco["idespaco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="areaespaco" name="areaespaco" placeholder="Informe o gênero da espaço" value="<?php echo htmlspecialchars( $espaco["areaespaco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
            <div class="form-group">
              <label for="observacao">Observação</label>
              <input type="text" class="form-control" id="observacao" name="observacao" placeholder="Informe qual é o programa" value="<?php echo htmlspecialchars( $espaco["observacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>    
            <div class="form-group">
              <label for="espaco">Local</label>
                <select class="form-control" name="idlocal">                       
                  <?php $counter1=-1;  if( isset($local) && ( is_array($local) || $local instanceof Traversable ) && sizeof($local) ) foreach( $local as $key1 => $value1 ){ $counter1++; ?>
                    <option <?php if( $value1["idlocal"] === $espaco["idlocal"] ){ ?>selected="selected"<?php } ?> value="<?php echo htmlspecialchars( $value1["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                <?php } ?>
            ...
            <div class="form-group">
              <label for="espaco">Local</label>
                <select class="form-control" name="idhorario">   
                  ...
                  <option {<?php if( $value1["idhorario"] === $espaco["idhorario"] ){ ?>selected="selected"<?php } ?> value="<?php echo htmlspecialchars( $value1["idhorario"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["horainicio"], ENT_COMPAT, 'UTF-8', FALSE ); ?> ás <?php echo htmlspecialchars( $value1["horatermino"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $value1["periodo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                  <?php } ?>                           
                </select>
          </div> 
        </div>          
