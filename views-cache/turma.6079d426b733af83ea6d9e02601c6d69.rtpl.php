            ...
            <div class="box-body" style="border: solid 1px lightblue; margin: 5px;">
              ...
              <div class="col-md-10" style="margin: 2; padding: 2; padding-top: 0px;">
                <h4 style="text-align: left;">
                 ...
                 <strong><?php echo htmlspecialchars( $value1["descativ"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
                 - <?php echo htmlspecialchars( $value1["periodo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>  
                 - <strong><?php echo htmlspecialchars( $value1["diasemana"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
                 ...
                 - <strong> [<?php echo htmlspecialchars( $value1["vagas"], ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas geral] </strong> 
                  [<?php echo htmlspecialchars( $value1["vagaslaudo"], ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas Laudo]  
                  <strong> [<?php echo htmlspecialchars( $value1["vagaspcd"], ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas PCD] </strong>
                  [<?php echo htmlspecialchars( $value1["vagaspvs"], ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas PVS] 
                 - <strong> Obsevação: <?php echo htmlspecialchars( $value1["obs"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </strong>
                </h4>
              </div>
