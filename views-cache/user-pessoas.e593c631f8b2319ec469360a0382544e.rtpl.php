<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="container"> <!-- container 1 -->
            ...
            <div class="col-md-12" >
                ...
                <div class="row alert alert-warning">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                              <h6>  <a href="/cursos/saude-atualiza/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["nomepess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Inserir / Atualizar Dados de Saúde <span style="color: #000"> (Clique aqui)</span></a> </h6>
                    </div>
                ...
                <div class="row alert alert-primary">
                    <div class="col-md-6 btn-primary" style="padding: 5px; text-align-last: center; width: 50%;">
                        <form action="post" name="idpess">
                            <a class="btn btn-primary" href="/cursos/user/pessoa/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">EDITAR</a>
                        </form>
                    </div>
                    <div class="col-md-6 btn-danger" style="padding: 5px; text-align-last: center; width: 50%;">
                        <form action="post" name="idpess">
                            <a class="btn btn-danger"  href="/cursos/user/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" role="button" onclick="return confirm('DESEJA realmente EXCLUIR o cadastro do(a) <?php echo htmlspecialchars( $value1["nomepess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')">EXCLUIR</a>
                        </form>
                    </div>
                </div> 
    ...
    <div class="alert alert-info" style="text-align-last: center;">
        <a class="btn btn-primary card-just-text" href="/cursos/pessoa-create" role="button" >INSERIR UMA NOVA PESSOA OU DEPENDENTE</a>
    </div>
