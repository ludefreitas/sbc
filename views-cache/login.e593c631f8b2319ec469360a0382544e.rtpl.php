            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">                    
                        ...
                        <form action="/cursos/login" id="register-form-wrap" class="login" method="post">
                            <h3>Acessar / Login</h3>
                            <p>Não tem conta?&nbsp;&nbsp; <a href="/cursos/user-create">Cadastre-se!</a>   </p>                  
                            ...
                            <p class="lost_password">
                                <a href="/cursos/forgot">Esqueceu a senha?</a>
                            </p>
                            <div class="clear"></div>
                        </form>  
