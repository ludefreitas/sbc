...
<div class="row">
  ...
  <div class="col-md-12">
      ...
      <div class="box-body" style="border: solid 1px lightblue; margin: 5px; padding-bottom: 0; "> 
        <form action="/admin/turma-temporada-hoje-icon/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="GET">
          ...
          <?php } ?>       
               ...
               <?php $counter1=-1;  if( isset($modalidades) && ( is_array($modalidades) || $modalidades instanceof Traversable ) && sizeof($modalidades) ) foreach( $modalidades as $key1 => $value1 ){ $counter1++; ?>            
                ...
                <?php if( numeroNaListaDePresençaByIdturmaData($value2["idturma"], $ano, $mes, $dia) == 0 ){ ?>
                    <div id="caixa<?php echo htmlspecialchars( $value2["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="box-body" style="border: solid 1px lightblue; margin: 5px; background-color: lightgray; ">
                <?php }else{ ?>
                    <div id="caixa<?php echo htmlspecialchars( $value2["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="box-body" style="border: solid 1px lightblue; margin: 5px; background-color: lightgreen; ">
                <?php } ?>                
