      ...
      */
        ...
        let calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          dateClick: function(info) {
            ...
            window.location.href=`http://www.cursosesportivos.com.br/prof/listaagendapordata/` + local + '/' + info.dateStr;          
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
          Selecione a data para atualizar a lista de presença da sua turma
      </h1>
