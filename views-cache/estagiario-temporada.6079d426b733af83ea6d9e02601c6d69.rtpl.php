...
<section class="content-header">
  <h1>
    Lista dos Estagiários da temporada <?php echo htmlspecialchars( $temporada["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
  </h1>
  <ol class="breadcrumb">
           ...
           <div class="box-body" style="border: solid 1px lightblue; margin: 5px;">
            ...
            <div class="box-body" style="border: solid 1px lightblue; margin: 5px;">
              ...
              <div class="col-md-2" style="margin: 2; padding: 2">
                    <a href="/admin/turma-temporada-estagiario/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/user/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-info btn-xs"><i class=""></i><span style="color: black;">Turmas do(a) estagiário(a) <br><?php echo htmlspecialchars( $value1["apelidoperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span></a>
              </div>

              &nbsp;&nbsp;&nbsp;&nbsp;

              <div class="col-md-2" style="margin: 2; padding: 2">
                 <a href="/admin/turmatemporada-estagiario/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class=""></i><span style="color: black;"> Inserir ou remover <br> turma do(a) estagiário(a)</span></a>                      
              </div>
