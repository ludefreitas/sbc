      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-success">
            ...
            <div class="box-body">
              <form role="form" action="/prof/listapessoasporturmapersonalizada/<?php echo htmlspecialchars( $idturma, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $idtemporada, ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
                <div class="row">
                  <div class="col-md-12">
