...
<hr style="background-color: #0f71b3;">
  ...
  <div class="col-md-12" style="border: 5px; font-family: 'Helvetica Neue', Helvetica, Arial,sans-serif;"> 
       ...
       Olá <span style="color: black; font-weight: bold;">  <?php echo getUserName(); ?>, </span>seja bem vindo! <br><br>
        ...
        As turmas de natação intermediário, avançado e aperfeiçoamento, são dedicadas aos alunos egressos das turmas de iniciantes, ou àquelas pessoas que já sabem nadar o básico, e pretendem aperfeiçoar o nado.
        <br><br>
 
        Para ingressar em uma dessas turmas, você deve realizar o agendamento de uma avaliação junto a nossa equipe de professores para verificar em qual turma você pode ingressar.
        <br><br>

        <strong> A realização do teste não garante vaga direto na turma.</strong> Para ingresar é necessário que exista vaga disponível.
        <br><br>   

        Se você já sabe nadar, independentemente do teste, você pode participar do agendamento de natação <a href="/locaisnatacao">Espontâneo</a>, onde basta apresentar os atestados cardiológicos e dermatológicos para participar.
        <br><br>   
  ...
  <div class="col-md-12" style="border: 5px; font-family: 'Helvetica Neue', Helvetica, Arial,sans-serif;"> 
      ...
      <div style="text-align-last: center; font-weight: bold; line-height: 15px; color: #0f71b3; font-size: 10px; font-style: italic; margin: 0px 5px 0px 5px; ">
           ...
           SELECIONE ABAIXO UM LOCAL PARA AGENDAR SUA AVALIAÇÃO DA NATAÇÃO
      </div>
