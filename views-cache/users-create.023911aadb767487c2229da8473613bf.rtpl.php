...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="/professor/users/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/professor/users/create" method="post">
          <div class="box-body">
            ...
            <div class="box-header">
              ...
              <input type="text" class="form-control" id="apelidoperson" name="apelidoperson" placeholder="Digite o Apelido">
            </div>
            <div class="box-header">
