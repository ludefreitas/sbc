  ...
  <hr style="background-color: #0f71b3;">
    ...
    <div class="col-md-12" style="border: 5px; font-family: 'Helvetica Neue', Helvetica, Arial,sans-serif;"> 
         ...
         Olá <span style="color: black; font-weight: bold;">  <?php echo getUserName(); ?>, </span>seja bem vindo! <br><br>
          ...
          INSCRIÇÕES XADREZ 2024<br><br>

          Para fazer a inscrição e matrícula na modalidade Xadrez, você deve entrar em contato com o profº Rodrigo Scimini através Whatsapp: <a href="https://wa.me/+5511944583463?text=Olá!" target="_blank" onclick="return confirm('Você será direcionado para o whatsapp do profº Rodrigo Scimini. Digite sua mensagem e no app clique em enviar msg.')"><i class="fa fa-whatsapp" style="color: darkgreen; font-weight: bold;"></i><span style="color: black;"> 94458 3463&nbsp;</span></a>                  
    ...
    <div class="container"> 
      <div class="row">    
          <div class="col-md-5 btn" style="text-align-last: left; background-color: #0f71b3; border: 5px white; margin: 0px 5px 5px 5px;  line-height: 20px; font-family: 'Helvetica Neue', Helvetica, Arial,sans-serif; text-align: center; border-radius: 15px;">  
               <a href="https://wa.me/+5511944583463?text=Olá!" target="_blank" onclick="return confirm('Você será direcionado para o whatsapp do profº Rodrigo Scimini. Digite sua mensagem e no app clique em enviar msg.')">
