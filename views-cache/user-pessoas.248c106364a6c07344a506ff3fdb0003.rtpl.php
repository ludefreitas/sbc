     ...
     <div class="container">
        ...
        <div class="row alert alert-primary">
            <div class="col-md-12" >
                ...
                &nbsp;<strong>Vuln. Social: </strong> <?php if( $value1["vulnsocial"] == 1 ){ ?>Sim<?php }else{ ?>Nao<?php } ?>
                ...
                &nbsp;<strong>Nome da MПлкe: </strong><?php echo htmlspecialchars( $value1["nomemae"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                &nbsp;<strong>CPF da mПлкe: </strong><?php echo htmlspecialchars( $value1["cpfmae"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                <?php } ?>                
