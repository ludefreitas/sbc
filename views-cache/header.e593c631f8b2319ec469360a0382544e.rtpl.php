            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="nav-principal">
                    <div class="navbar-nav ml-auto" style="text-align: center;">                        
                        ...
                        <div class="nav-item">
                            <a href="/cursos/user/profile" class="nav-link">
                              <span class="text-white" style="font-weight: bold">
                        ...
                        <div class="nav-item">
                            <a href="/cursos/cart" class="nav-link">
                              <span class="text-white" style="font-weight: bold">
                        ...
                        <div class="nav-item">
                            <a href="cursos/pessoa-create" class="nav-link">
                              <span class="text-white" style="font-weight: bold">
                                Inserir uma pessoa  
                              </span>
                            </a> 
                        ...
                        <div class="nav-item" >
                            <a style="" class="nav-link" href="/cursos/logout" >
                              <span class="text-white" style="font-weight: bold">
                                 Sair
                              </span>
                            </a>
                        ...
                        <?php }else{ ?>
                        <div class="nav-item" >
                            <a style="" class="nav-link" href="/cursos/login" >
                              <span class="text-white" style="font-weight: bold">
                                 Entrar 
                              </span>
                            </a>
