                  ...
                  <div class="row">
                   ...
                   <table class="col-md-12">
                        ...
                        <tr>
                            ...
                            <td style="border: solid 1px; text-align: left; font-weight: bold; padding: 2px; background: rgba(255, 0, 0, 0.15);"><?php echo htmlspecialchars( $value1["idinsc"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $value1["nomepess"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <span style="color: red;"> ( Desistente )</span> </td>
                            <?php }else{ ?>
