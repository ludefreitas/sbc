...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="/admin/evento-temporada/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Eventos por temporada</a></li>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6" style="margin: 2; padding: 2">
                    <h5 style="text-align: left;">               
                      ...
                      &nbsp;<strong>Dt Excluão.: </strong><?php echo formatDate($value2["dt_exclusao_insc_evento"]); ?>&nbsp;
                    </h5>
                  </div>                   
                </div>
              </div>
