...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/admin/local/create">Cadastrar Crec</a></li>
  </ol>
</section>
      ...
      <div class="box box-primary">
        ...
        <?php } ?>
          ...
          <div class="box-header">
            ...
            <a href="/admin/local/create" class="btn btn-success">Cadastrar Crec</a>
            <div class="box-tools">
                <form action="/admin/local">
             ...
             <div class="row">              
              ...
              <div class="col-md-6" >
                <h5 style="font-weight: bold; text-align: left;">                  
                   ...
                   <a href="/admin/local/<?php echo htmlspecialchars( $value1["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                  <a href="/admin/local/<?php echo htmlspecialchars( $value1["idlocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir o Crec <?php echo htmlspecialchars( $value1["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                </h5>
              </div>
