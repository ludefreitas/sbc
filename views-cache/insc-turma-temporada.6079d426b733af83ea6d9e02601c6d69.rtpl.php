                  ...
                  <div class="col-md-6" style="margin: 2; padding: 2">
                    <h5 style="text-align: left;">
                      ...
                      <?php if( existeParq($value1["idpess"]) ){ ?>
                        ...
                        <strong><a style="font-weight: bold; color: green;" href="/admin/par-q/pessoa/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"> <i style="color: orange;" class="fa fa-exclamation-triangle"> </i> PAR-Q <i style="color: orange;" class="fa fa-exclamation-triangle"> </i></a> </strong>

                        <?php }else{ ?>

                        <strong><a style="font-weight: bold; color: green;" href="/admin/par-q/pessoa/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"> PAR-Q </a> </strong>
              ...
              <?php if( $value1["idinscstatus"] == 2 ){ ?>
                ...
                <?php if( $numMatriculados >= $vagas ){ ?>
                  ...
                  <h5 style="font-weight: bold; text-align: left;">  
                    ...
                    <a href="/admin/turma/create/token/<?php echo htmlspecialchars( $turma["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["numcpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-info btn-xs"><i></i> Gerar token</a>
                    ...
                    <div class="col-md-12">
                        <h5 style="text-align: left;">
                            ...
                            <span style="line-height: 10px; height: 20px; color: red; right: 0;">       
                                <a href="/prof/insc/<?php echo htmlspecialchars( $value1["idinsc"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $turma["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/statusDesistente" role="button" onclick="return confirm('Deseja realmente informar como desistente o(a) <?php echo htmlspecialchars( $value1["nomepess"], ENT_COMPAT, 'UTF-8', FALSE ); ?> da inscrição <?php echo htmlspecialchars( $value1["idinsc"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')" style="color: red;"> 
                                    Excluir 
                                </a>  
                            </span>
                        </h5>                               
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 style="text-align: left;">
                            ...
                            <a href="/admin/profile/insc/<?php echo htmlspecialchars( $value1["idinsc"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $turma["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">
                                Detalhes
                            </a>
                            &nbsp;&nbsp;
