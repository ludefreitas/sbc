            ...
            <div class="row">
                ...
                <div class="col-md-7">                    
                   ...
                   <p>
                    ...
                    <p>
                        <label style="font-size: 12px; margin: 0px">Número do CPF (Somente números)</label>
                         <input style="width: 100%; float: right;" type="text" maxlength="14" id="numcpf" name="numcpf" class="form-control" value="<?php echo htmlspecialchars( $registerpessoaValues["numcpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onfocus="javascript: retirarFormatacao(this);" onblur="javascript: formatarCampo(this);" required="required">
