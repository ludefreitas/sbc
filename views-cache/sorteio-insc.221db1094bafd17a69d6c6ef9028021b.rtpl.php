            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Resultado de sorteio</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                         ...
                         <?php if( $dtnasc < 18 ){ ?>
                          <tr>
                            <td class="body-text-cell">
                              A inscrição <?php echo htmlspecialchars( $idinsc, ENT_COMPAT, 'UTF-8', FALSE ); ?> do(a) <?php echo htmlspecialchars( $nomepess, ENT_COMPAT, 'UTF-8', FALSE ); ?>, para a turma <strong><?php echo htmlspecialchars( $turma["descativ"], ENT_COMPAT, 'UTF-8', FALSE ); ?>,</strong> foi sorteada com o <strong>N° <?php echo htmlspecialchars( $numerosorteado, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> na <strong style="fsont-size: 16px; color: darkblue;"><?php echo htmlspecialchars( $numeroordenado, ENT_COMPAT, 'UTF-8', FALSE ); ?>ª </strong>posição. Sendo assim, estamos aguardando o(a) <?php echo htmlspecialchars( $nomepess, ENT_COMPAT, 'UTF-8', FALSE ); ?>, acompanhado do responsável, para fazer a matrícula presencialmente, no dia e horário de inicio das aulas.                        
                            </td>                            
                          </tr>
                          <?php } ?>
                          ...
                          <tr>
                            <td class="body-text-cell">
                              A inscrição <?php echo htmlspecialchars( $idinsc, ENT_COMPAT, 'UTF-8', FALSE ); ?> do(a) <?php echo htmlspecialchars( $nomepess, ENT_COMPAT, 'UTF-8', FALSE ); ?>, para a turma <strong><?php echo htmlspecialchars( $turma["descativ"], ENT_COMPAT, 'UTF-8', FALSE ); ?>,</strong> foi sorteada com o <strong>N° <?php echo htmlspecialchars( $numerosorteado, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> na <strong style="fsont-size: 16px; color: darkblue;"><?php echo htmlspecialchars( $numeroordenado, ENT_COMPAT, 'UTF-8', FALSE ); ?>ª </strong>posição. Sendo assim, estamos aguardando o(a) <?php echo htmlspecialchars( $nomepess, ENT_COMPAT, 'UTF-8', FALSE ); ?>, para fazer a matrícula presencialmente, no dia e horário de inicio das aulas.                        
                            </td>                            
                          </tr>
                          ...
                          <tr>
                            <td class="body-text-cell">
                              Detalhes da turma: <strong><?php echo htmlspecialchars( $turma["descativ"], ENT_COMPAT, 'UTF-8', FALSE ); ?>,</strong> <?php echo htmlspecialchars( $turma["diasemana"], ENT_COMPAT, 'UTF-8', FALSE ); ?> das <strong><?php echo htmlspecialchars( $turma["horainicio"], ENT_COMPAT, 'UTF-8', FALSE ); ?> ás <?php echo htmlspecialchars( $turma["horatermino"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </strong>no <strong><?php echo htmlspecialchars( $turma["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> - Rua <?php echo htmlspecialchars( $turma["rua"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $turma["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $turma["bairro"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - SBC
                            </td> 
                          </tr>
                          <tr>                            
                            <td class="body-text-cell">
                              Clique no link abaixo, acesse sua conta, para conferir mais detalhes da inscrição <a href="http://www.cursosesportivossbc.com.br">www.cursosesportivossbc.com.br</a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
