                ...
                <div class="col-md-12">
                    ...
                    <div class="row" style="margin-top: 0px; margin-bottom: 0px;">
                        <div class="col-md-12 alert alert-success" style="text-align: justify; padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px;">
                            ...
                            com o(a) professor(a) <?php echo htmlspecialchars( $value1["apelidoperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, no <strong><?php echo htmlspecialchars( $value1["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> - <?php echo htmlspecialchars( $value1["rua"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - Nº <?php echo htmlspecialchars( $value1["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - bairro <?php echo htmlspecialchars( $value1["bairro"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $value1["cidade"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <span style="color: red;">(<?php echo htmlspecialchars( $value1["numinscritos"], ENT_COMPAT, 'UTF-8', FALSE ); ?> inscritos para <?php echo htmlspecialchars( $value1["vagas"], ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas)</span>
                        ...
                        <div class="checkbox">
                            ...
                            <?php if( $inscGeral >= $maxListaEsperaGeral ){ ?>
                                ...
                                <?php if( $tokencpf != 0 ){ ?>
                                    <input type="radio" name="tipoinsc" id="tipoinsc" value="2" onclick="enormal()" style="height: 20px; width: 20px;"> &nbsp; Esta é uma inscrição para <strong>PÚBLICO em GERAL.</strong> <span style="font-size: 12px; color: red">(<?php echo htmlspecialchars( $inscGeral, ENT_COMPAT, 'UTF-8', FALSE ); ?> insc. para <?php echo htmlspecialchars( $vagasGeral, ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas) </span>
                                <br>
                            ...
                            <div id="geral" hidden="true">    
                             <?php if( $inscGeral >= $vagasGeral ){ ?>                             
                                <div class="col-md-12 alert alert-danger" style="padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px; text-align: justify;">
                                    <!--
                                    <input type="radio" name="espera" required="required" style="height: 20px; width: 20px;">&nbsp; Ao clicar nesta opção de que esta inscrição não garante vaga e que estou numa lista de espera no Grupo do Público em Geral, aguardando ser comunicado de uma eventual vaga. Confirmo ainda que tenho cadastrado e atualizado, neste site, meu número de telefone celular com whatsapp para receber o comunicado.
                                -->
                            ...
                            <?php }else{ ?>
                                <div class="col-md-12 alert alert-danger" style="padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px; text-align: justify;">
                                Lembre-se: As aulas já começaram, então você deve comprarecer com os documentos pessoais no <?php echo htmlspecialchars( $value1["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, sem falta, já na próxima <?php echo htmlspecialchars( $value1["diasemana"], ENT_COMPAT, 'UTF-8', FALSE ); ?> das <?php echo htmlspecialchars( $value1["horainicio"], ENT_COMPAT, 'UTF-8', FALSE ); ?> às <?php echo htmlspecialchars( $value1["horatermino"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.
                                </div> 
                            ...
                            <?php if( $inscPlm >= $maxListaEsperaPlm ){ ?>

                                <?php if( $tokencpf != 0 ){ ?>

                                    <input type="radio" name="tipoinsc" id="tipoinsc" value="3" onclick="comlaudo()" style="height: 20px; width: 20px;">&nbsp; Esta inscrição é para pessoa com <strong>LAUDO MÉDICO.</strong><br> (Indicação Médica com CID) <span style="font-size: 12px; color: red">(<?php echo htmlspecialchars( $inscPlm, ENT_COMPAT, 'UTF-8', FALSE ); ?> insc. para <?php echo htmlspecialchars( $vagasPlm, ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas)</span>                                
                                    <br>
                            ...
                            <div id="temlaudo" hidden="true">                                
                                ...
                                <?php if( $inscPlm >= $vagasPlm ){ ?>
                                    <div class="col-md-12 alert alert-danger" style="padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px; text-align: justify;">
                                        <!--
                                        <input type="radio" name="espera" required="required" style="height: 20px; width: 20px;">&nbsp; Ao clicar nesta opção de que esta inscrição não garante vaga e que estou numa lista de espera do Grupo de Pessoas Com Laudo Médico, aguardando ser comunicado de uma eventual vaga. Confirmo ainda que tenho cadastrado e atualizado, neste site, meu número de telefone celular com whatsapp para receber o comunicado.
                                    -->
                            ...
                            <?php if( $inscPcd >= $maxListaEsperaPcd ){ ?>
                                <?php if( $tokencpf != 0 ){ ?>

                                    <input type="radio" name="tipoinsc" id="tipoinsc" value="4" onclick="comdeficiencia()" style="height: 20px; width: 20px;">&nbsp; Esta inscrição é para <strong>PESSOA COM DEFICIÊNCIA.</strong> <span style="font-size: 12px; color: red">(<?php echo htmlspecialchars( $inscPcd, ENT_COMPAT, 'UTF-8', FALSE ); ?> insc. para <?php echo htmlspecialchars( $vagasPcd, ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas)</span>
                                    <br>
                            ...
                            <?php }else{ ?>
                                ...
                                <?php if( $value1["idlocal"] == 5 ){ ?>
                                    ...
                                    <?php }else{ ?>
                                        ...
                                        <input disabled="true" type="radio" name="tipoinsc" id="tipoinsc" value="4" onclick="comdeficiencia()" style="height: 20px; width: 20px;">&nbsp; Esta inscrição é para <strong>PESSOA COM DEFICIÊNCIA.</strong> <span style="font-size: 12px; color: red">(<?php echo htmlspecialchars( $inscPcd, ENT_COMPAT, 'UTF-8', FALSE ); ?> insc. para <?php echo htmlspecialchars( $vagasPcd, ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas)</span>&nbsp;
                            ...
                            <div id="deficiente" hidden="true">
                                ...
                                <?php if( $inscPcd >= $vagasPcd ){ ?>
                                    <div class="col-md-12 alert alert-danger" style="padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px; text-align: justify;">
                                        <!--
                                        <input type="radio" name="espera" required="required">&nbsp;&nbsp; Ao clicar nesta opção de que esta inscrição não garante vaga e que estou numa lista de espera do Grupo de Pessoas Com Deficiência, aguardando ser comunicado de uma eventual vaga. Confirmo que tenho cadastrado e atualizado, neste site, meu número de telefone celular com whatsapp para receber o comunicado.
                                    -->
                            ...
                            <?php if( $inscPvs >= $maxListaEsperaPvs ){ ?>

                                <?php if( $tokencpf != 0 ){ ?>

                                    <input type="radio" name="tipoinsc" id="tipoinsc" value="5" onclick="comvulnerabilidade()" style="height: 20px; width: 20px;">&nbsp; Esta inscrição é para pessoa em <strong>VULNERABILIDADE SOCIAL.</strong> <span style="font-size: 12px; color: red">(<?php echo htmlspecialchars( $inscPcd, ENT_COMPAT, 'UTF-8', FALSE ); ?> insc. para <?php echo htmlspecialchars( $vagasPcd, ENT_COMPAT, 'UTF-8', FALSE ); ?> vagas)</span>
                                    <br>
                            ...
                            <div id="vulneravel" hidden="true"> 
                                ...
                                <?php if( $inscPvs >= $vagasPvs ){ ?>
                                    <div class="col-md-12 alert alert-danger" style="padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px; text-align: justify;">
                                        <!--
                                        <input type="radio" name="espera" required="required" style="height: 20px; width: 20px;">&nbsp; Ao clicar nesta opção de que esta inscrição não garante vaga e que estou numa lista de espera do Grupo de Pessoas em Vulnerabilidade Social, aguardando ser comunicado de uma eventual vaga. Confirmo que tenho cadastrado e atualizado, neste site, meu número de telefone celular com whatsapp para receber o comunicado.
                                    -->
                                    Ao clicar nesta opção de inscrição você está ciente que esta não garante vaga e que você está numa lista de espera do Grupo de Pessoas em Vulnerabilidade Social, aguardando ser comunicado de uma eventual vaga. Você confirma ainda que tem cadastrado e atualizado, neste site, seu número de telefxone celular com whatsapp para receber o comunicado.
                                    </div> 
                                <?php }else{ ?>
                                    <div class="col-md-12 alert alert-danger" style="padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px; text-align: justify;">
                                    Lembre-se: As aulas já começaram, então você deve comprarecer com os documentos pessoais no <?php echo htmlspecialchars( $value1["apelidolocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, sem falta, já na próxima <?php echo htmlspecialchars( $value1["diasemana"], ENT_COMPAT, 'UTF-8', FALSE ); ?> das <?php echo htmlspecialchars( $value1["horainicio"], ENT_COMPAT, 'UTF-8', FALSE ); ?> às <?php echo htmlspecialchars( $value1["horatermino"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.
    ...
    <! ------- ATÉ AQUI ---------------------------------------->
                    ...
                    <div class="row" style="padding-top: 0px;">
                       ...
                       <div class="col-md-6 alert alert-success" style="text-align-last: center; padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px;">
                            <input type="radio" name="ciente" required="required" style="height: 20px; width: 20px;"><label style="color: red; padding-top: 10px;">&nbsp;Ciente</label>
                        </div>
                        <div class="col-md-6 alert alert-success" style="text-align-last: center; padding-top: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px;">
