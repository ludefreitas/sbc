           ...
           <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box-header">
                  ...
                  <input type="number" class="form-control" id="vagas" name="vagas" placeholder="Informe a quantidade de vagas público geral" value="<?php echo htmlspecialchars( $turma["vagas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>   

                <div class="box-header">
                  <label for="turma">Vagas público laudo</label>
                  <input type="number" class="form-control" id="vagaslaudo" name="vagaslaudo" placeholder="Informe a quantidade de vagas público com laudo" value="<?php echo htmlspecialchars( $turma["vagaslaudo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>   

                <div class="box-header">
                  <label for="turma">Vagas PCD</label>
                  <input type="number" class="form-control" id="vagaspcd" name="vagaspcd" placeholder="Informe a quantidade de vagas público PCD " value="<?php echo htmlspecialchars( $turma["vagaspcd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>   

                <div class="box-header">
                  <label for="turma">Vagas vulnerabilidade social</label>
                  <input type="number" class="form-control" id="vagaspvs" name="vagaspvs" placeholder="Informe a quantidade de vagas público vulnerabilidade social" value="<?php echo htmlspecialchars( $turma["vagaspvs"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>   
