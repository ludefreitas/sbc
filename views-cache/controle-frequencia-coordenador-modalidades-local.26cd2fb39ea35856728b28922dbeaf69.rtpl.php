...
<div class="col-md-12">
  ...
  <?php $counter1=-1;  if( isset($modalidades) && ( is_array($modalidades) || $modalidades instanceof Traversable ) && sizeof($modalidades) ) foreach( $modalidades as $key1 => $value1 ){ $counter1++; ?>
      <a href="/prof/controle-frequencia-coordenador-por-modalidade-local/<?php echo htmlspecialchars( $temporada["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idmodal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $idlocal, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class=""></i><?php echo htmlspecialchars( $value1["descmodal"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </a>&nbsp;&nbsp;&nbsp;&nbsp;
  <?php } ?>
      ...
      <table class="table table-bordered" id="table">
        ...
        <tbody>
          <tr style="padding: 5px"> 
              ...
              <td style="text-align: center; border: solid 1px; padding: 5px;">  
                <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-01-01">                             
                <?php echo ControleFrequenciaJan($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>    </a> 
              </td>             
              <td style="text-align: center; border: solid 1px; padding: 5px;"> 
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-02-01">                              
                <?php echo ControleFrequenciaFev($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>     </a>
              </td>
              <td style="text-align: center; border: solid 1px; padding: 5px;">   
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-03-01">                            
                <?php echo ControleFrequenciaMar($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>     </a>
              </td>      
              <td style="text-align: center; border: solid 1px; padding: 5px;">
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-04-01">                               
                <?php echo ControleFrequenciaAbr($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>     </a>
              </td> 
              <td style="text-align: center; border: solid 1px; padding: 5px;">   
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-05-01">                            
                <?php echo ControleFrequenciaMai($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>     </a>
              </td>     
              <td style="text-align: center; border: solid 1px; padding: 5px;">  
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-06-01">                              
                <?php echo ControleFrequenciaJun($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>  </a>   
              </td>   
              <td style="text-align: center; border: solid 1px; padding: 5px;">  
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-07-01">                              
                <?php echo ControleFrequenciaJul($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>  </a>   
              </td>    
              <td style="text-align: center; border: solid 1px; padding: 5px;">  
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-08-01">                
                <?php echo ControleFrequenciaAgo($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>    </a> 
              </td> 
              <td style="text-align: center; border: solid 1px; padding: 5px;">   
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-09-01">               
                <?php echo ControleFrequenciaSet($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>     </a>
              </td> 
              <td style="text-align: center; border: solid 1px; padding: 5px;">   
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-10-01">               
                <?php echo ControleFrequenciaOut($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>    </a> 
              </td>   
              <td style="text-align: center; border: solid 1px; padding: 5px;">                
              <a style="color: black;" href="/prof/insc-turma-temporada-chamada-mensal/<?php echo htmlspecialchars( $value1["idtemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-11-01">  <?php echo ControleFrequenciaNov($value1["idturma"], $value1["idtemporada"], $value1["desctemporada"]); ?>  </a>   
              </td>
          </tr>
          </tbody>
          <?php }else{ ?>
