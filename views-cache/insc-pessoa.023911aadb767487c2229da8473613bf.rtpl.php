                ...
                <div id="" style="position: relative;">
                    ...
                    <table class="">
                        <thead>                           
                            ...
                            <tr>
                                ...
                                <td class="product-name"><?php echo htmlspecialchars( $value1["descturma"], ENT_COMPAT, 'UTF-8', FALSE ); ?> (<?php echo htmlspecialchars( $value1["periodo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>) - <?php echo htmlspecialchars( $value1["desctemporada"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="product-name">&nbsp;&nbsp;<?php echo htmlspecialchars( $value1["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                            </tr>                                        
                    ...
                    <div class="product-big-title-area">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3>Não localizamos inscrições para o(a) <?php echo htmlspecialchars( $pessoa["nomepess"], ENT_COMPAT, 'UTF-8', FALSE ); ?> CPF: <?php echo htmlspecialchars( $pessoa["numcpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </h3>
                                </div>
                            </div>
                        </div>
                    </div>
