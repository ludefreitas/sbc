<?php if(!class_exists('Rain\Tpl')){exit;}?>
    ...
    <script type="text/javascript">
        ...
        function AtualizaAtestadoClinico() {
            ...
            if((traco1 != '-') || (traco2 != '-') || (ano.length < 4)){
                ...
                if((dia > 31) || (dia == 0) || (mes > 12) || (mes == 0)){
                    ...
                    let url = '/prof/saude/atualizaatestado/'+idpess+'/'+data+'/'+observ+'/'+iduser
        ...
        function AtualizaAtestadoDerma() {
            ...
            let url = '/prof/saude/atualizaatestadoderma/'+idpess+'/'+data+'/'+observ+'/'+iduser
                 ...
                 if((traco1 != '-') || (traco2 != '-') || (ano.length < 4)){
                    ...
                    alert('data inválida!')
                        ...
                        if (observ == null || observ == "") {
                            ...
                            let url = '/prof/saude/atualizaatestado/'+idpess+'/'+data+'/'+observ+''
                 ...
                 if((traco1 != '-') || (traco2 != '-') || (ano.length < 4)){
                    ...
                    alert('data inválida!')
                        ...
                        if (observ == null || observ == "") {
                            ...
                            let url = '/prof/saude/atualizaatestadoderma/'+idpess+'/'+data+'/'+observ+''
