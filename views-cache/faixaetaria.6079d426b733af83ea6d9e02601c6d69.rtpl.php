  	...
  	<div class="col-md-12">
        ...
        <?php } ?>
            ...
            <div class="box-header">
              <a href="/admin/faixaetaria/create" class="btn btn-success">Cadastrar Faixa Etária</a>

              <div class="box-tools">
                <form action="/admin/faixaetaria">
            ...
            <div class="box-body" style="border: solid 1px lightblue; margin: 5px;">
              ...
              <div class="col-md-2" style="margin: 2; padding: 2">
                <a href="/admin/faixaetaria/<?php echo htmlspecialchars( $value1["idfxetaria"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                      <a href="/admin/faixaetaria/<?php echo htmlspecialchars( $value1["idfxetaria"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir esta faixa etária de <?php echo htmlspecialchars( $value1["descrfxetaria"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
              </div>
