  	...
  	<div class="col-md-12">
          ...
          <?php } ?>
            ...
            <div class="box-body" style="border: solid 1px lightblue; margin: 5px;">
              ...
              <div class="col-md-2" >
                   <a href="/prof/insc/pessoa/<?php echo htmlspecialchars( $value1["idpess"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["numcpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-search"></i>&nbsp;Consulta inscrições</a>
              </div>
  ...
  <div hidden id="divPopupAtestado" style="text-align-last: center; border-radius: 15px 15px 15px 15px"> 
                ...
                <div style="text-align: center; padding: 5; width: 100%;">
                    <form id="formAtestado" method="get" style="height: 100%;"> 
                        ...
                        <input id="data" name="data" type="text" required="required" style="height: 30px; margin-bottom: 2px; width: 90%" placeholder="Somente números 00-00-0000" onkeypress="formatar('##-##-####', this)" maxlength="10">
                        <br> 
            ...
            <div hidden id="divPopupAtestadoDerma" style="text-align-last: center; border-radius: 15px 15px 15px 15px"> 
                ...
                <div style="text-align: center; padding: 5; width: 100%;">
                    <form id="formAtestadoDerma" method="get" style="height: 100%;"> 
                        ...
                        <input id="dataderma" name="data" type="text" required="required" style="height: 30px; margin-bottom: 2px; width: 90%" placeholder="Somente números 00-00-0000" onkeypress="formatar('##-##-####', this)" maxlength="10">
                        <br> 
