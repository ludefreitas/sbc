...
$app->get("/cursos/user-create", function(){
...
$app->post("/cursos/register", function(){
	...
	if (!isset($_POST['name']) || $_POST['name'] == '') {
		...
		header("Location: /cursos/user-create");
		exit;
	}
	...
	*/
	...
	$_POST["nomemae"] = (isset($_POST["nomemae"])) ? $_POST["nomemae"]: '';
	$_POST["cpfmae"] = (isset($_POST["cpfmae"])) ? $_POST["cpfmae"]: '';
	$_POST["nomepai"] = (isset($_POST["nomepai"])) ? $_POST["nomepai"]: '';
	$_POST["cpfpai"] = (isset($_POST["cpfpai"])) ? $_POST["cpfpai"]: '';
...
$app->post("/cursos/user/profile", function(){
	...
	if (!isset($_POST['desperson']) || $_POST['desperson'] === '') {
		...
		header('Location: /cursos/user/profile');
		exit;
	}
...
$app->post("/cursos/user-change-password", function(){
	...
	if (!isset($_POST['current_pass']) || $_POST['current_pass'] === '') {
		...
		header("Location: /cursos/user-change-password");
		exit;
